...
public record EvalMetricsSummary(EvalMetricValue goalPassRate, EvalMetricValue strictPassRate,
		EvalMetricValue expectationPassRate, EvalMetricValue intentAccuracy,
		...
		EvalMetricValue multiTurnFollowupAccuracy, EvalMetricValue plannerAccuracy,
		EvalMetricValue plannerEnabledAccuracy, EvalMetricValue plannerDecisionAccuracy) {
}
